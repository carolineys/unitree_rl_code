...
class LeggedRobot(BaseTask):
    ...
    def post_physics_step(self):
        ...
        print("gravity",self.gravity_vec)
    ...
    def _compute_torques(self, actions):
        ...
        print(control_type)
        print("p_gains", self.p_gains)
        print("d_gains", self.d_gains)
